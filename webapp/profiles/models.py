...
class UserWall(models.Model):
    ...
    def add_note(self, title, text, rules, awards, author, user,attachment):
        return self.post_set.create(title = title, text=text, rules=rules,awards=awards, author=author,user=user,attachment=attachment)
